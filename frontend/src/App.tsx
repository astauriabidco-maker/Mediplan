...
const HierarchyPage = lazy(() => import('./pages/HierarchyPage').then((module) => ({ default: module.HierarchyPage })))
const SettingsPage = lazy(() => import('./pages/Settings'))
const PayrollPage = lazy(() => import('./pages/PayrollPage').then((module) => ({ default: module.PayrollPage })))
const HospitalServicesPage = lazy(() => import('./pages/HospitalServicesPage').then((module) => ({ default: module.HospitalServicesPage })))
const AgentsPage = lazy(() => import('./pages/AgentsPage').then((module) => ({ default: module.AgentsPage })))
const CompetenciesPage = lazy(() => import('./pages/CompetenciesPage').then((module) => ({ default: module.CompetenciesPage })))
const PlanningPage = lazy(() => import('./pages/Planning').then((module) => ({ default: module.PlanningPage })))
...
const GedPage = lazy(() => import('./pages/GedPage').then((module) => ({ default: module.GedPage })))
const QvtPage = lazy(() => import('./pages/QvtPage').then((module) => ({ default: module.QvtPage })))
const ContractTemplatesPage = lazy(() => import('./pages/ContractTemplatesPage').then((module) => ({ default: module.ContractTemplatesPage })))
const PublicSignPage = lazy(() => import('./pages/PublicSignPage').then((module) => ({ default: module.PublicSignPage })))
const SyncPage = lazy(() => import('./pages/PlaceholderPages').then((module) => ({ default: module.SyncPage })))
