...
import { TrendingUp, TrendingDown, Users, DollarSign, Activity, AlertCircle, Shield, Award, Heart, ChevronRight } from 'lucide-react';
...
export const DashboardPage = () => {
    ...
    return (
        <div className="p-8 space-y-8 animate-[fadeIn_0.5s_ease-out] max-w-[1600px] mx-auto pb-20">
            ...
            <Suspense fallback={<div className="h-80 rounded-3xl border border-slate-800 bg-slate-900/60 animate-pulse" />}>
