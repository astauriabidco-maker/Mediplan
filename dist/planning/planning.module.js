    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                shift_entity_1.Shift, agent_entity_1.Agent, leave_entity_1.Leave, leave_balance_entity_1.LeaveBalance, work_policy_entity_1.WorkPolicy,
                shift_application_entity_1.ShiftApplication, shift_proposal_entity_1.ShiftProposal, attendance_entity_1.Attendance,
                hospital_service_entity_1.HospitalService, health_record_entity_1.HealthRecord, agent_competency_entity_1.AgentCompetency,
