...
var UiController = function () {
    var _classDecorators = [(0, common_1.Controller)('ui')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getStats_decorators;
    var UiController = _classThis = /** @class */ (function () {
        function UiController_1(agentRepository, competencyRepository, localeRules) {
            this.agentRepository = (__runInitializers(this, _instanceExtraInitializers), agentRepository);
            this.competencyRepository = competencyRepository;
            this.localeRules = localeRules;
        }
        UiController_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var agentsCount, competenciesCount;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.agentRepository.count()];
                        case 1:
                            agentsCount = _a.sent();
                            return [4 /*yield*/, this.competencyRepository.count()];
                        case 2:
                            competenciesCount = _a.sent();
                            return [2 /*return*/, {
