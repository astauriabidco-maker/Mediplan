...
var CreateAgentDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateAgentDto() {
                ...
                __runInitializers(this, _telephone_extraInitializers);
            }
            return CreateAgentDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _nom_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _email_decorators = [(0, class_validator_1.IsEmail)()];
            _matricule_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _telephone_decorators = [(0, class_validator_1.IsPhoneNumber)()];
