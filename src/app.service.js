...
var AppService = function () {
    ...
    var AppService = _classThis = /** @class */ (function () {
        function AppService_1(localeRules) {
            this.localeRules = localeRules;
        }
        AppService_1.prototype.getHello = function () {
            var limit = this.localeRules.getWeeklyWorkLimit();
            var mm = this.localeRules.supportsMobileMoney();
            return "Hello World! Work Limit: ".concat(limit, "h, Mobile Money: ").concat(mm);
        };
        AppService_1.prototype.getConfig = function () {
            return {
                configuration: {
