...
var PaymentService = function () {
    ...
    var PaymentService = _classThis = /** @class */ (function () {
        function PaymentService_1(localeRules) {
            this.localeRules = localeRules;
            this.logger = new common_1.Logger(PaymentService.name);
        }
        PaymentService_1.prototype.triggerPayment = function (agentId, amount) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    this.logger.log("Processing Orange Money payment of ".concat(amount, " for agent ").concat(agentId, "..."));
                    // Simulate API call
                    return [2 /*return*/, { status: 'SUCCESS', transactionId: "TXN-".concat(Date.now()), amount: amount, agentId: agentId, provider: 'Orange Money' }];
                });
            });
        };
