...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1(appService, seedService) {
            this.appService = (__runInitializers(this, _instanceExtraInitializers), appService);
            this.seedService = seedService;
        }
        AppController_1.prototype.seed = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.seedService.seed()];
                });
            });
        };
        AppController_1.prototype.getConfig = function () {
    ...
    (function () {
        ...
        _seed_decorators = [(0, common_1.Get)('dev/seed')];
        _getConfig_decorators = [(0, common_1.Get)()];
