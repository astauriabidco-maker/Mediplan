...
var agent_competency_entity_1 = require("./agent-competency.entity");
var Competency = function () {
    ...
    var Competency = _classThis = /** @class */ (function () {
        function Competency_1() {
            ...
            this.agentCompetencies = (__runInitializers(this, _category_extraInitializers), __runInitializers(this, _agentCompetencies_initializers, void 0));
            __runInitializers(this, _agentCompetencies_extraInitializers);
        }
        return Competency_1;
    }());
    __setFunctionName(_classThis, "Competency");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _name_decorators = [(0, typeorm_1.Column)()];
        _category_decorators = [(0, typeorm_1.Column)()];
        _agentCompetencies_decorators = [(0, typeorm_1.OneToMany)(function () { return agent_competency_entity_1.AgentCompetency; }, function (agentCompetency) { return agentCompetency.competency; })];
        ...
        Competency = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Competency = _classThis;
}();
